...
const getMyChats = TryCatch(async (req, res, next) => {
  ...
  const tansformedChats = chats.map(({ _id, name, members, groupChat }) => {
...
// ekk var ma multiple members add thay
...
// ekk ekk kri ne members remove thse
